...
export const DEFAULT_HEADING: WithoutId<TextElement> = {
  type: 'heading',
  x: 100, y: 80, width: 400, height: 60,
  opacity: 100, zIndex: 1,
  name: 'Heading', visible: true, locked: false,
  content: 'Heading',
  fontSize: 36, fontFamily: 'Inter', fontWeight: 'bold',
  color: '#1a1a2e', backgroundColor: 'transparent',
  textAlign: 'left', borderRadius: 0, hLevel: 1,
...
export const DEFAULT_PARAGRAPH: WithoutId<TextElement> = {
  type: 'paragraph',
  x: 100, y: 160, width: 400, height: 80,
  opacity: 100, zIndex: 1,
  name: 'Paragraph', visible: true, locked: false,
...
export const DEFAULT_BUTTON: WithoutId<TextElement> = {
  type: 'button',
  x: 100, y: 260, width: 180, height: 48,
  opacity: 100, zIndex: 1,
  name: 'Button', visible: true, locked: false,
  content: 'Button',
  fontSize: 16, fontFamily: 'Inter', fontWeight: 'bold',
  color: '#ffffff', backgroundColor: '#6c63ff',
...
export const DEFAULT_RECTANGLE: WithoutId<ShapeElement> = {
  ...
  opacity: 100, zIndex: 1,
  name: 'Rectangle', visible: true, locked: false,
...
export const DEFAULT_CIRCLE: WithoutId<ShapeElement> = {
  ...
  opacity: 100, zIndex: 1,
  name: 'Circle', visible: true, locked: false,
  backgroundColor: '#e5e7eb', borderColor: '#d1d5db',
...
export const DEFAULT_IMAGE: WithoutId<ImageElement> = {
  ...
  opacity: 100, zIndex: 1,
  name: 'Image', visible: true, locked: false,
  placeholder: 'Image description',
  borderRadius: 8, objectFit: 'cover', objectPosition: 'center',
  shadow: 'none', borderWidth: 0, borderColor: '#d1d5db', grayscale: false,
};
